...
| **Identity & Access Management** | Zitadel OIDC for human users, OAuth 2.1 for machine-to-machine, service accounts, role-based access control | `PROJECT_PLAN.md`, `docs/runbooks/RUNBOOK-006-zitadel-sso.md`, `scripts/bootstrap-zitadel.sh`, `docs/architecture/ZITADEL_GITLAB_PERMISSION_SYNC.md` |
