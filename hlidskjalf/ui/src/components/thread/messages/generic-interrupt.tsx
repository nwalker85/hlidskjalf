...
function renderInterruptStateItem(value: any): React.ReactNode {
  if (isComplexValue(value)) {
    return (
      <code className="rounded bg-raven-800 px-2 py-1 font-mono text-sm text-raven-300">
    ...
    return (
      <a
        ...
        className="break-all text-huginn-400 underline hover:text-huginn-300"
      >
        {value}
      </a>
    );
    ...
    <div className="overflow-hidden rounded-lg border border-raven-700">
      <div className="border-b border-raven-700 bg-raven-800 px-4 py-2">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <h3 className="font-medium text-raven-100">Human Interrupt</h3>
        </div>
      </div>
      <motion.div
