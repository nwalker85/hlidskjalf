...
// Default values for the form - uses environment variables or ravenhelm.test domains
const DEFAULT_API_URL = process.env.NEXT_PUBLIC_LANGGRAPH_API_URL || "https://norns.ravenhelm.test";
const DEFAULT_ASSISTANT_ID = process.env.NEXT_PUBLIC_LANGGRAPH_ASSISTANT_ID || "norns";
      ...
      <div className="flex min-h-screen w-full items-center justify-center p-4 bg-raven-950">
        <div className="animate-in fade-in-0 zoom-in-95 bg-raven-900 flex max-w-3xl flex-col rounded-lg border border-raven-800 shadow-lg">
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              <Label htmlFor="apiKey" className="text-raven-200">LangSmith API Key</Label>
              <p className="text-raven-500 text-sm">
